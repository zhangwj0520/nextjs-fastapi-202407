...
export function DesktopNav() {
  ...
  return (
    <aside className={cn('inset-y-0 left-0 z-10 hidden flex flex-col border-r bg-background sm:flex duration-3000 transition-all', isSidebarOpen ? ' w-[200px]' : ' w-[68px]')}>
